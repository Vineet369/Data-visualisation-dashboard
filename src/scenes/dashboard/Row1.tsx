...
import { ResponsiveContainer,AreaChart,CartesianGrid,XAxis,YAxis,Tooltip,Area, Line, LineChart, Legend, BarChart, Bar } from "recharts";
...
const Row1 = () => {
  ...
  const revenueExpenses = useMemo(() => {        //runs only when 'data' changes
    return (
      data && 
  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis tickLine={false} style={{fontSize: "12px"}} axisLine={{ strokeWidth: "0"}} domain={[8000, 23000]}/>
          <Tooltip />
